    ...
    <>
      ...
      >
            ...
            return (
              <Link
                ...
                className={`
                  ...
                  ${isActive(item.href) ? 'text-blue-400' : 'text-gray-400 hover:text-gray-200 hover:bg-gray-800'}
                `}
              >
        ...
        <div className="hidden lg:block p-4 border-t border-gray-800">
          <div className="text-xs text-gray-500 text-center">QRganize v1.1.0</div>
        </div>
      </aside>
    </>
  )
